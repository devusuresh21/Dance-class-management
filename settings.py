...
SECRET_KEY = 'django-insecure-u)!k1h+8s=65&9bhc8qz8)b*!q*w6aasa&&h4j@==xka-s3!&x'
...
EMAIL_USE_TLS = True # Replace with True if your SMTP server uses TLS
EMAIL_HOST_USER = 'admin@gmail.com' # Replace with your email address
EMAIL_HOST_PASSWORD = '123' # Replace with your email password
